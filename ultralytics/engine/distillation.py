"""
This file is based on blog: https://blog.csdn.net/qq_40387714/article/details/148203432 by paradoxjun
Modifications made by YYL for MyUltralytics
"""
...
class YOLOv8DistillationLoss:
    ...
    """
    def __init__(self, model_s, model_t, distiller="mgd", device=None):
        self.distiller = distiller.lower()
        # 判定蒸馏类型
        ...
        if self._type == "feature":
            ...
            ch_s, ch_t = [], []
            for lid in _YOLOV8_DISTILL_LAYER:
...
if __name__ == '__main__':
    ...
    model_s_path = "../../trains_det/kx_s_250210/S3_ft_048/weights/best.pt"
    model_t_path = "../../trains_det/kx_s_250210/train/weights/best.pt"
 
    model_s = YOLO(model_s_path)
    model_t = YOLO(model_t_path)
 
    distill = YOLOv8DistillationLoss(model_s.model, model_t.model, distiller="CWD")