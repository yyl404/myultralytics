...
# # 转换数据集的类别ID
# python tools/incremental_utils.py --convert_dataset_class_id --data_cfg data/VOC_inc_15_5/task_2_cls_5/dataset.yaml \
#     --model_path runs/yolov8l_voc_inc_15_5_fromscratch/task-2/task-1-best_expanded.pt \
#     --save_dir runs/yolov8l_voc_inc_15_5_fromscratch/task-2/dataset_train_without_pseudo_labels
...
#     --model_path runs/yolov8l_voc_inc_15_5_fromscratch/task-2/task-1-best_expanded.pt \
#     --save_dir runs/yolov8l_voc_inc_15_5_fromscratch/task-2/dataset_eval
...
# python tools/train.py --model runs/yolov8l_voc_inc_15_5_fromscratch/task-2/task-1-best_expanded.pt \
#     --data runs/yolov8l_voc_inc_15_5_fromscratch/task-2/dataset_pseudo_labels/dataconfig.yaml \
#     --save_path runs/yolov8l_voc_inc_15_5_fromscratch/task-2/best-without-pseudolabels.pt \
#     --epochs 100 \
#     --batch_size 16 \
#     --imgsz 640 \
#     --workers 8 \
