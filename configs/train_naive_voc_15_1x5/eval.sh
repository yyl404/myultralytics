...
python tools/eval_incremental.py --data_cfg data/VOC_inc_15_1x5/task_1-2_cls_16/dataset.yaml \
    --model_path runs/yolov8l_voc_inc_15_1x5_fromscratch/task-2/best.pt --save_dir runs/yolov8l_voc_inc_15_1x5_fromscratch/eval_task-2
...
python tools/eval_incremental.py --data_cfg data/VOC_inc_15_1x5/task_1-3_cls_17/dataset.yaml \
    --model_path runs/yolov8l_voc_inc_15_1x5_fromscratch/task-3/best.pt --save_dir runs/yolov8l_voc_inc_15_1x5_fromscratch/eval_task-3
...
python tools/eval_incremental.py --data_cfg data/VOC_inc_15_1x5/task_1-4_cls_18/dataset.yaml \
    --model_path runs/yolov8l_voc_inc_15_1x5_fromscratch/task-4/best.pt --save_dir runs/yolov8l_voc_inc_15_1x5_fromscratch/eval_task-4
...
python tools/eval_incremental.py --data_cfg data/VOC_inc_15_1x5/task_1-5_cls_19/dataset.yaml \
    --model_path runs/yolov8l_voc_inc_15_1x5_fromscratch/task-5/best.pt --save_dir runs/yolov8l_voc_inc_15_1x5_fromscratch/eval_task-5
...
python tools/eval_incremental.py --data_cfg data/VOC_inc_15_1x5/task_1-6_cls_20/dataset.yaml \
    --model_path runs/yolov8l_voc_inc_15_1x5_fromscratch/task-6/best.pt --save_dir runs/yolov8l_voc_inc_15_1x5_fromscratch/eval_task-6