...
OUTPUT_DIR="runs/yolov8x_voc_10_10_fromcls_osr_pseudo_label"
EPOCHS=100
BATCH_SIZE=16
IMGSZ=640
WORKERS=8
...
TASK1_DATASET="data/VOC_10_10/task_1_cls_10/dataset.yaml"
TASK2_DATASET="data/VOC_10_10/task_2_cls_10/dataset.yaml"
...
CONVERTED_DATASET="$TASK2_DIR/task_2_cls_10_converted"
...
echo "================ OSR Object Aug ================="
OSR_CP="$TASK2_DIR/task_2_cls_10_osr_cp"
python tools/osr.py \
  --copy_paste_replay \
...
OSR_FA="$TASK2_DIR/task_2_cls_10_osr_fa"
python tools/osr.py \
...
echo "================ Merge Datasets ================="
MERGED_DATASET="$TASK2_DIR/task_2_cls_10_osr_full"
