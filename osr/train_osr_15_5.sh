...
OUTPUT_DIR="runs/yolov8x_voc_15_5_fromcls_osr_pseudo_label"
EPOCHS=100
BATCH_SIZE=16
IMGSZ=640
WORKERS=8
...
TASK1_DATASET="data/VOC_15_5/task_1_cls_15/dataset.yaml"
TASK2_DATASET="data/VOC_15_5/task_2_cls_5/dataset.yaml"
...
echo "================ OSR Object Aug ================="
OSR_CP="$TASK2_DIR/task_2_cls_5_osr_cp"
python tools/osr.py \
  --copy_paste_replay \
...
OSR_FA="$TASK2_DIR/task_2_cls_5_osr_fa"
python tools/osr.py \
...
echo "================ Merge Datasets ================="
MERGED_DATASET="$TASK2_DIR/task_2_cls_5_osr_full"
