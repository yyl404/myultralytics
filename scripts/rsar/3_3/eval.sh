#!/bin/bash
# Evaluation script for RSAR 3_3 incremental setting.
# Independent of initial weight/backbone: pass any training run OUTPUT_DIR for this split.
# Usage: bash eval.sh [OUTPUT_DIR]
# Example: bash eval.sh runs/yolov8l_rsar_3_3_fromscratch_pseudo_label

OUTPUT_DIR="${1:-runs/yolov8l_rsar_3_3_fromscratch_pseudo_label}"
...
CUMULATIVE_DATASETS=(
    "data/RSAR_3_3/task_1_cls_3/dataset.yaml"
    "data/RSAR_3_3/task_1-2_cls_6/dataset.yaml"
)
...
echo "=========================================="
echo "Incremental Learning Model Evaluation (RSAR 3_3)"
echo "=========================================="
