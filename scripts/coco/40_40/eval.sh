#!/bin/bash
# Evaluation script for COCO 40_40 incremental setting.
# Independent of initial weight/backbone: pass any training run OUTPUT_DIR for this split.
# Usage: bash eval.sh [OUTPUT_DIR]
# Example: bash eval.sh runs/yolov8l_coco_40_40_fromscratch_pseudo_label

OUTPUT_DIR="${1:-runs/yolov8l_coco_40_40_fromscratch_pseudo_label}"
...
CUMULATIVE_DATASETS=(
    "data/coco_40_40/task_1_cls_40/dataset.yaml"
    "data/coco_40_40/task_1-2_cls_80/dataset.yaml"
)
...
echo "=========================================="
echo "Incremental Learning Model Evaluation (COCO 40_40)"
echo "=========================================="
