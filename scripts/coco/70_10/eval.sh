#!/bin/bash
# Evaluation script for COCO 70_10 incremental setting.
# Independent of initial weight/backbone: pass any training run OUTPUT_DIR for this split.
# Usage: bash eval.sh [OUTPUT_DIR]
# Example: bash eval.sh runs/yolov8l_coco_70_10_fromscratch_pseudo_label

OUTPUT_DIR="${1:-runs/yolov8l_coco_70_10_fromscratch_pseudo_label}"
...
CUMULATIVE_DATASETS=(
    "data/COCO_70_10/task_1_cls_70/dataset.yaml"
    "data/COCO_70_10/task_1-2_cls_80/dataset.yaml"
)
...
echo "=========================================="
echo "Incremental Learning Model Evaluation (COCO 70_10)"
echo "=========================================="
