...
OUTPUT_DIR="${1:-runs/yolov8l_hrsc_pretrained-yoloe_proto_rp}"  # Default value if not specified
...
CUMULATIVE_DATASETS=(
    "/root/myultralytics/data/HRSC2016-YOLO-Coarse_1x4/task_1-2_cls_2/dataset.yaml"
    "/root/myultralytics/data/HRSC2016-YOLO-Coarse_1x4/task_1-3_cls_3/dataset.yaml"
)
