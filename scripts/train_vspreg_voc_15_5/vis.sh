...
python tools/vis.py --pca_cache_path runs/yolov8l_voc_inc_15_5_fromscratch/task-1/pca_cache_all-layers.joblib \
    ...
    --sample_dir runs/yolov8l_voc_inc_15_5_fromscratch/task-2/dataset_train/images/val \
    --label_dir runs/yolov8l_voc_inc_15_5_fromscratch/task-2/dataset_train/labels/val \
    --unfold --sample_num 100 --xlim_main "0,2.5" --xlim_kernel_update "0,0.05" --module_filter "model 10:23"
