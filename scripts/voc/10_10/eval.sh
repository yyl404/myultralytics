#!/bin/bash
# Evaluation script for VOC 10_10 incremental setting.
# Independent of initial weight/backbone: pass any training run OUTPUT_DIR for this split.
# Usage: bash eval.sh [OUTPUT_DIR]
# Example: bash eval.sh runs/yolov8l_voc_inc_10_10_fromscratch_pseudo_label

OUTPUT_DIR="${1:-runs/yolov8l_voc_inc_10_10_fromscratch_pseudo_label}"
...
CUMULATIVE_DATASETS=(
    "data/VOC_inc_10_10/task_1_cls_10/dataset.yaml"
    "data/VOC_inc_10_10/task_1-2_cls_20/dataset.yaml"
)
...
echo "=========================================="
echo "Incremental Learning Model Evaluation (VOC 10_10)"
echo "=========================================="
