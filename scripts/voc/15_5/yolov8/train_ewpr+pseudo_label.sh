...
OUTPUT_DIR="runs/yolov8l_voc_15_5_fromscratch_ewpr+pseudo_label"
EPOCHS=300
BATCH_SIZE=16
IMGSZ=640
WORKERS=8
...
# EWPR Configuration
# Can be overridden via command line: EWPR_LOSS_WEIGHT=1000.0 bash train_ewpr+pseudo_label.sh
EWPR_LOSS_WEIGHT=${EWPR_LOSS_WEIGHT:-1000.0}
