...
CUMULATIVE_DATASETS=(
    "data/VOC_10+2+2+2+2+2/task_1_cls_10/dataset.yaml"
    "data/VOC_10+2+2+2+2+2/task_1-2_cls_12/dataset.yaml"
    "data/VOC_10+2+2+2+2+2/task_1-3_cls_14/dataset.yaml"
    "data/VOC_10+2+2+2+2+2/task_1-4_cls_16/dataset.yaml"
    "data/VOC_10+2+2+2+2+2/task_1-5_cls_18/dataset.yaml"
    "data/VOC_10+2+2+2+2+2/task_1-6_cls_20/dataset.yaml"
)
...
echo "=========================================="
echo "Incremental Learning Model Evaluation (VOC 10+2+2+2+2+2)"
echo "=========================================="
