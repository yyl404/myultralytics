#!/bin/bash
# Evaluation script for VOC 19_1 incremental setting.
# Independent of initial weight/backbone: pass any training run OUTPUT_DIR for this split.
# Usage: bash eval.sh [OUTPUT_DIR]
# Example: bash eval.sh runs/yolov8l_voc_19_1_fromscratch_pseudo_label

OUTPUT_DIR="${1:-runs/yolov8l_voc_19_1_fromscratch_pseudo_label}"
...
echo "=========================================="
echo "Incremental Learning Model Evaluation (VOC 19_1)"
echo "=========================================="
