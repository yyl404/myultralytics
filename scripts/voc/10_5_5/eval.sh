#!/bin/bash
# Evaluation script for VOC 10_5_5 incremental setting.
# Independent of initial weight/backbone: pass any training run OUTPUT_DIR for this split.
# Usage: bash eval.sh [OUTPUT_DIR]
# Example: bash eval.sh runs/yolov8x_VOC_10+5+5_pretrained-from-yolov8x-cls_pseudo_label

OUTPUT_DIR="${1:-runs/yolov8x_VOC_10+5+5_pretrained-from-yolov8x-cls_pseudo_label}"
EVAL_OUTPUT_DIR="${OUTPUT_DIR}/evaluation_results"
DEVICE=0

TASK_DATASETS=(
    "data/VOC_10+5+5/task_1_cls_10/dataset.yaml"
    "data/VOC_10+5+5/task_2_cls_5/dataset.yaml"
    "data/VOC_10+5+5/task_3_cls_5/dataset.yaml"
)

CUMULATIVE_DATASETS=(
    "data/VOC_10+5+5/task_1_cls_10/dataset.yaml"
    "data/VOC_10+5+5/task_1-2_cls_15/dataset.yaml"
    "data/VOC_10+5+5/task_1-3_cls_20/dataset.yaml"
)
...
echo "=========================================="
echo "Incremental Learning Model Evaluation (VOC 10+5+5)"
echo "=========================================="
