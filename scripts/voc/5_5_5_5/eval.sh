#!/bin/bash
# Evaluation script for VOC 5_5_5_5 incremental setting.
# Independent of initial weight/backbone: pass any training run OUTPUT_DIR for this split.
# Usage: bash eval.sh [OUTPUT_DIR]
# Example: bash eval.sh runs/yolov8x_VOC_5+5+5+5_pretrained-from-yolov8x-cls_pseudo_label

OUTPUT_DIR="${1:-runs/yolov8x_VOC_5+5+5+5_pretrained-from-yolov8x-cls_pseudo_label}"
...
CUMULATIVE_DATASETS=(
    "data/VOC_5+5+5+5/task_1_cls_5/dataset.yaml"
    "data/VOC_5+5+5+5/task_1-2_cls_10/dataset.yaml"
    "data/VOC_5+5+5+5/task_1-3_cls_15/dataset.yaml"
    "data/VOC_5+5+5+5/task_1-4_cls_20/dataset.yaml"
)
...
echo "=========================================="
echo "Incremental Learning Model Evaluation (VOC 5+5+5+5)"
echo "=========================================="
